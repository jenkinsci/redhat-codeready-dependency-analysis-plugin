...
- CRDA CLI Version (Optional): The crda cli version that you need to run underneath. (Accepted format example v0.1.1). It will pick the default value [v0.1.1] if no value is provided.
